...
urlpatterns = [
    ...
    path('api/student-lookup/<str:student_id>/', views.api_student_lookup, name='api_student_lookup'),
    path('api/student-lookup-by-name/', views.api_student_lookup_by_name, name='api_student_lookup_by_name'),
